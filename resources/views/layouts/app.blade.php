    ...
    <script src="https://cdn.ckeditor.com/ckeditor5/39.0.1/classic/ckeditor.js"></script>
        ...
        <style>
            ...
            ::-webkit-scrollbar-track {
                background: #ffffff0c; /* slate-50 */
            }
            ::-webkit-scrollbar-thumb {
                background: #ffffff1f; /* slate-400 */
                border-radius: 10px;
            }
    ...
    <body class="flex h-screen bg-slate-100">
        ...
        <aside id="sidebar" class="w-64 bg-slate-800 text-slate-100 flex flex-col fixed inset-y-0 left-0 z-30 transform -translate-x-full lg:translate-x-0 lg:relative">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                @endphp
                <a href="{{ route('teacher.dashboard') }}" class="sidebar-link flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 {{ $isDashboardActive ? 'active' : '' }}">
                    <i data-feather="home" class="w-5 h-5 mr-3"></i>
                    <span>Dashboard</span>
                </a>

                <a href="#" class="sidebar-link flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700">
                ...
                <div class="relative">
                    @php
                        ...
                        $isUserRoleActive = Request::routeIs('users.*') || Request::routeIs('permission.*') || Request::routeIs('role.*') || Request::routeIs('user.assign.role');
                    @endphp
                    <a href="#" class="sidebar-link flex items-center justify-between px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 {{ $isUserRoleActive ? 'active' : '' }}" data-submenu="user-role-submenu">
                    ...
                    <div id="user-role-submenu" class="submenu-container {{ $isUserRoleActive ? 'expanded' : 'collapsed' }} pl-8 pt-1 pb-1.5 space-y-1">
                        
                        <a href="{{ route('role.list') }}" class="sidebar-link flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 text-sm {{ Request::routeIs('role.list') || Request::routeIs('role.edit') ? 'active' : '' }}">
                            <span>Roles</span>
                        </a>
                        <a href="{{ route('role.create') }}" class="sidebar-link flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 text-sm {{ Request::routeIs('role.create') ? 'active' : '' }}">
                            <span>Create Roles</span>
                        </a>
                        <a href="{{ route('permission.create') }}" class="sidebar-link flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 text-sm {{ Request::routeIs('permission.create') ? 'active' : '' }}">
                            <span>Create Permissions</span>
                        </a>
                        <a href="{{ route('user.assign.role') }}" class="sidebar-link flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 text-sm {{ Request::routeIs('user.assign.role') ? 'active' : '' }}">
                ...
                <div class="relative">
                    @php
                        $isUserRoleActive = Request::routeIs('exams.*') || Request::routeIs('mcq_questions.*') || Request::routeIs('cq_questions.*') || Request::routeIs('exams.answer') || Request::routeIs('exams.answer.questions') || Request::routeIs('exams.answer.questions.show');
                    @endphp
                    <a href="{{ route('exams.index') }}" class="sidebar-link flex items-center justify-between px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 {{ $isUserRoleActive ? 'active' : '' }}" data-submenu="exams-submenu">
                        <div class="flex items-center">
                            <i data-feather="users" class="w-5 h-5 mr-3"></i>
                            <span>
                                Exams
                    ...
                    <div id="exams-submenu" class="submenu-container {{ $isUserRoleActive ? 'expanded' : 'collapsed' }} pl-8 pt-1 pb-1.5 space-y-1">
                        
                        <a href="{{ route('exams.index') }}" class="sidebar-link flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 text-sm {{ Request::routeIs('exams.index') ? 'active' : '' }}">
                            <span>All Exam</span>
                        </a>
                        <a href="{{ route('exams.create') }}" class="sidebar-link flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 text-sm {{ Request::routeIs('exams.create') ? 'active' : '' }}">
                            <span>Create Exam</span>
                        </a>
                        <a href="{{ route('exams.answer') }}" class="sidebar-link flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 text-sm {{ Request::routeIs('exams.answer') ? 'active' : '' }}">
                ...
                <div class="relative">
                    ...
                    @endphp
                    <a href="{{ route('student.index') }}" class="sidebar-link flex items-center justify-between px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 {{ $isUserRoleActive ? 'active' : '' }}" data-submenu="studentCreate-submenu">
                        <div class="flex items-center">
                            <i data-feather="users" class="w-5 h-5 mr-3"></i>
                            <span>
                                Students
                    ...
                    <div id="studentCreate-submenu" class="submenu-container {{ $isUserRoleActive ? 'expanded' : 'collapsed' }} pl-8 pt-1 pb-1.5 space-y-1">
                        
                        <a href="{{ route('student.index') }}" class="sidebar-link flex items-center px-4 py-2.5 rounded-lg transition-colors duration-200 hover:bg-slate-700 text-sm {{ Request::routeIs('student.index') ? 'active' : '' }}">
